...
class GateCodeTest {
    ...
    void parseIntructionsLeft() {
        String input = "L22";
        List<GateCode.Instruction> expected = List.of(new GateCode.RotateLeftInstruction(22));
    ...
    void parseIntructionsRight() {
        String input = "R999";
        List<GateCode.Instruction> expected = List.of(new GateCode.RotateRightInstruction(999));
    ...
    void processInstructionsMethod0x434C49434BBasic() {
        ...
        GateCode expected = new GateCode(new Dial(0, 100), 3);
    ...
    void processInstructionsMethod0x434C49434BExample() {
        ...
        GateCode expected = new GateCode(new Dial(32, 100), 6);
